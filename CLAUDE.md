...
This project is indexed by GitNexus as **medical_agent** (2924 symbols, 6412 relationships, 206 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

"""Test Internist Agent Structured Output.

Verifies that the Internist Agent produces consistent, well-structured responses.
"""
...
from src.agent.output_schemas import (
    InternistOutputSchema,
    format_internist_output,
    get_output_instructions_for_agent
)

// web/app/(dashboard)/officer/page.tsx
"use client";

import { useState } from "react";
import { useOfficerDashboard } from "./use-officer-dashboard";
import { OfficerKpiBar } from "@/components/officer/officer-kpi-bar";
import { DepartmentStatusGrid } from "@/components/officer/department-status-grid";
import { DepartmentDetailDialog } from "@/components/officer/department-detail-dialog";
import { VisitPipelineKanban } from "@/components/officer/visit-pipeline-kanban";
import { PatientLocationTracker } from "@/components/officer/patient-location-tracker";
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="border-b border-white/[0.06] shrink-0">
        <OfficerKpiBar stats={stats} lastUpdated={lastUpdated} />
      </div>

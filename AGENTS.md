...
This project is indexed by GitNexus as **medical_agent** (4070 symbols, 10711 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **medical_agent** (4130 symbols, 11076 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
